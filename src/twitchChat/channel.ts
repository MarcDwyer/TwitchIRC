import { TwitchChat } from "./twitch_chat";
import { IrcMessage } from "./twitch_data";
import { TwitchCommands } from "./twitch_commands";
...
export class Channel {
  ...
  constructor(public key: string, private tc: TwitchChat & { ws: WebSocket }) {
  ...
  removeEventListener(event: ChannelEvents) {
